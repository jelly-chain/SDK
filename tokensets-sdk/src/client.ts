/**
 * Tokensets SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface TokensetsConfig extends BaseSDKConfig {
  chainId?: ChainId;
}
...
export class TokensetsSDK extends BaseSDK {
  ...
  constructor(config: TokensetsConfig) {
    super(config, "Tokensets");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Tokensets", status: "active", chainId: this.chainId };
  }
