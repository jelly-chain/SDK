/**
 * Metaculus SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface MetaculusConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class MetaculusSDK extends BaseSDK {
  ...
  async getInfo(): Promise<any> {
    return { name: "Metaculus", status: "active", chainId: this.chainId };
  }
