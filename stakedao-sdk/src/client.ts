/**
 * Stakedao SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface StakedaoConfig extends BaseSDKConfig {
  chainId?: ChainId;
}
...
export class StakedaoSDK extends BaseSDK {
  ...
  constructor(config: StakedaoConfig) {
    super(config, "Stakedao");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Stakedao", status: "active", chainId: this.chainId };
  }
