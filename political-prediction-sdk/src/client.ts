/**
 * PoliticalPrediction SDK - Protocol integration
 */
...
export class PoliticalPredictionSDK extends BaseSDK {
  ...
  async getInfo(): Promise<any> {
    return { name: "PoliticalPrediction", status: "active", chainId: this.chainId };
  }
