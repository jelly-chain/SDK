/**
 * Teia SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface TeiaConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class TeiaSDK extends BaseSDK {
  readonly chainId: ChainId;
  
  constructor(config: TeiaConfig) {
    super(config, "Teia");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Teia", status: "active", chainId: this.chainId };
  }
