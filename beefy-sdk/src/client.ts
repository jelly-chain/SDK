/**
 * Beefy SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface BeefyConfig extends BaseSDKConfig {
  chainId?: ChainId;
}
...
export class BeefySDK extends BaseSDK {
  ...
  constructor(config: BeefyConfig) {
    super(config, "Beefy");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Beefy", status: "active", chainId: this.chainId };
  }
