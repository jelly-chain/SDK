...
export interface udriftprotocolsdkConfig extends BaseSDKConfig { chainId: number; }
export class udriftprotocolsdk extends BaseSDK {
  readonly chainId: number;
  constructor(config: SDKConfig) {
    super(config, "udriftprotocolsdk");
