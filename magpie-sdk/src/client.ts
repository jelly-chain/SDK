/**
 * Magpie SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface MagpieConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class MagpieSDK extends BaseSDK {
  ...
  async getInfo(): Promise<any> {
    return { name: "Magpie", status: "active", chainId: this.chainId };
  }
