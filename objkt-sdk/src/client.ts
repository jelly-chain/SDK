/**
 * Objkt SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface ObjktConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class ObjktSDK extends BaseSDK {
  readonly chainId: ChainId;
  
  constructor(config: ObjktConfig) {
    super(config, "Objkt");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Objkt", status: "active", chainId: this.chainId };
  }
