/**
 * Binom SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface BinomConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class BinomSDK extends BaseSDK {
  ...
  async getInfo(): Promise<any> {
    return { name: "Binom", status: "active", chainId: this.chainId };
  }
