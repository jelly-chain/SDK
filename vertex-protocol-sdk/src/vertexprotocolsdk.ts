...
export interface uvertexprotocolsdkConfig extends BaseSDKConfig { chainId: number; }
export class uvertexprotocolsdk extends BaseSDK {
  readonly chainId: number;
  constructor(config: SDKConfig) {
    super(config, "uvertexprotocolsdk");
