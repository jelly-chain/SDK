/**
 * Catalog SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface CatalogConfig extends BaseSDKConfig {
  chainId?: ChainId;
}

export class CatalogSDK extends BaseSDK {
  ...
  async getInfo(): Promise<any> {
    return { name: "Catalog", status: "active", chainId: this.chainId };
  }
