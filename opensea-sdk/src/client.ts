/**
 * Opensea SDK - Protocol integration
 */
import { BaseSDK, type BaseSDKConfig, ChainId } from "@jellychain/sdk-core";

export interface OpenseaConfig extends BaseSDKConfig {
  chainId?: ChainId;
}
...
export class OpenseaSDK extends BaseSDK {
  ...
  constructor(config: OpenseaConfig) {
    super(config, "Opensea");
    this.chainId = config.chainId || ChainId.ETHEREUM;
  }

  async getInfo(): Promise<any> {
    return { name: "Opensea", status: "active", chainId: this.chainId };
  }
